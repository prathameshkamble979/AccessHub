...
import { loginWithGoogle } from '../controllers/auth.controller.web';
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='field'>
              ...
              <input
                ...
                placeholder={
                  loginMethod === 'email' ? 'you@example.com' : '9876543210'
                }
      ...
      <div className='auth-panel auth-panel--brand'>
        <div className='brand-content'>
          ...
          <p className='brand-sub'>
            Log in to track your website's progress, review designs, and manage
